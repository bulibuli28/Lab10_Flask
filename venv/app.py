...
image_file_path = os.path.join(static_folder_path, 'images', 'logo.png')
...
print(f"DEBUG: Expected logo.png path: {image_file_path}")
print(f"DEBUG: Does logo.png exist at expected path? {os.path.exists(image_file_path)}")
